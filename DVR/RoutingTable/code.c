...
struct RoutingTable
{
	struct Device devices[4];     //setting up 4 nodes
};
...
struct RoutingTable rt;     //structure for routing table
...
int main()
{
	...
	char ports[/*no_of_devices*/][20] = {"9009", "9010", "9011", "9012"};  //4 diff ports
